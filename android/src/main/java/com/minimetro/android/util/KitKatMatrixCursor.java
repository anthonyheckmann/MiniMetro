package com.minimetro.android.util;
 ...
 * as needed.
 */
public class KitKatMatrixCursor extends AbstractCursor {
     ...
     */
    public KitKatMatrixCursor(String[] columnNames, int initialCapacity) {
     ...
     *  determines column ordering elsewhere in this cursor
     */
    public KitKatMatrixCursor(String[] columnNames) {
        this(columnNames, 16);
    }
